...
public class BrushStrokesDP {

	public static void main(String[] args) {
	}

	static String currString;
	static HashMap<int[], Integer> mem = new HashMap<int[], Integer>();
	...
	public static int checkOrGet(int index, int numStrokesLeft, int currStroke) {
		if (mem.containsKey(new int[] { index, numStrokesLeft, currStroke }))
			return mem.get(new int[] { index, numStrokesLeft, currStroke });
		else {
			int ans = recCall(index, numStrokesLeft, currStroke);
			mem.put(new int[] { index, numStrokesLeft, currStroke }, ans);
			return ans;
		}
