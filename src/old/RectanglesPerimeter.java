...
public class RectanglesPerimeter {
    ...
    static PriorityQueue<Rectangle> openedRects = new PriorityQueue<Rectangle>(11, new OpenedComparator());
    static PriorityQueue<Rectangle> maxHeightRects = new PriorityQueue<Rectangle>(11, new MaxHeightComparator());
...
class Rectangle implements Comparable<Rectangle> {
    ...
    public String toString() {
        return "old.Rectangle: " + this.x + " " + this.width + " " + this.height;
    }
